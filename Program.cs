...
public class MyClass
{
    ...
    //List<string> listaDasBandas = new List<string> { "Metallica", "AC/DC", "Iron Maiden", "Guns N' Roses", "Led Zeppelin", "Linkin Park" };
    ...
    public static void ExibirMedia()
    {
        ...
        Console.WriteLine($"\nQual banda você deseja verificar a média? ");
        string nomeDaBanda = Console.ReadLine()!;
        if (bandasRegistradas.ContainsKey(nomeDaBanda))
        {
        ...
        {
            Console.WriteLine($"\nA banda {nomeDaBanda} não possui notas para somarem uma média.");
            Console.WriteLine("\nDigite uma tecla para voltar ao menu principal");
            Console.ReadKey();
            Console.Clear();
            ExibirOpcoesDoMenu();
